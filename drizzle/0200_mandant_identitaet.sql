...
grant update (kurzname, identitaets_token,
              logo_hell_pfad, logo_dunkel_pfad, logo_druck_pfad, logo_alt,
              avatar_pfad, avatar_alt, cover_pfad, cover_alt,
              claim, kurzbeschreibung, beschreibung,
              brief_fuss, rechnung_fuss, angebot_fuss,
              email_absender, email_signatur, domain,
              oeffentlich_sichtbar, platzhalter_medien,
