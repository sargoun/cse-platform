...
insert into berechtigung (schluessel, modul, objekt, aktion, bezeichnung, nur_global, sortierung) values
  ...
  ('angebot.annahme_erfassen', 'angebot', 'annahme', 'erfassen'::berechtigung_aktion, 'angebot.annahme_erfassen', false, 1),
  ('angebot.lesen', 'angebot', 'angebot', 'lesen'::berechtigung_aktion, 'angebot.lesen', false, 2),
  ('angebot.preis_freigeben', 'angebot', 'preis', 'freigeben'::berechtigung_aktion, 'angebot.preis_freigeben', false, 3),
  ('angebot.schreiben', 'angebot', 'angebot', 'schreiben'::berechtigung_aktion, 'angebot.schreiben', false, 4),
  ('angebot.versenden', 'angebot', 'angebot', 'versenden'::berechtigung_aktion, 'angebot.versenden', false, 5),
  ('aufgabe.lesen', 'aufgabe', 'aufgabe', 'lesen'::berechtigung_aktion, 'aufgabe.lesen', false, 6),
  ('aufgabe.schreiben', 'aufgabe', 'aufgabe', 'schreiben'::berechtigung_aktion, 'aufgabe.schreiben', false, 7),
  ('aufgabe.zuweisen', 'aufgabe', 'aufgabe', 'zuweisen'::berechtigung_aktion, 'aufgabe.zuweisen', false, 8),
  ('auftrag.abschliessen', 'auftrag', 'auftrag', 'abschliessen'::berechtigung_aktion, 'auftrag.abschliessen', false, 9),
  ('auftrag.lesen', 'auftrag', 'auftrag', 'lesen'::berechtigung_aktion, 'auftrag.lesen', false, 10),
  ('auftrag.schreiben', 'auftrag', 'auftrag', 'schreiben'::berechtigung_aktion, 'auftrag.schreiben', false, 11),
  ('bau.aufmass_erfassen', 'bau', 'aufmass', 'erfassen'::berechtigung_aktion, 'bau.aufmass_erfassen', false, 12),
  ('bau.aufmass_freigeben', 'bau', 'aufmass', 'freigeben'::berechtigung_aktion, 'bau.aufmass_freigeben', false, 13),
  ('bau.behinderung_erstellen', 'bau', 'behinderung', 'erstellen'::berechtigung_aktion, 'bau.behinderung_erstellen', false, 14),
  ('bau.lesen', 'bau', 'bau', 'lesen'::berechtigung_aktion, 'bau.lesen', false, 15),
  ('bau.nachtrag_anmelden', 'bau', 'nachtrag', 'anmelden'::berechtigung_aktion, 'bau.nachtrag_anmelden', false, 16),
  ('bau.nachtrag_einreichen', 'bau', 'nachtrag', 'einreichen'::berechtigung_aktion, 'bau.nachtrag_einreichen', false, 17),
  ('bau.preis_lesen', 'bau', 'preis', 'lesen'::berechtigung_aktion, 'bau.preis_lesen', false, 18),
  ('bau.schreiben', 'bau', 'bau', 'schreiben'::berechtigung_aktion, 'bau.schreiben', false, 19),
  ('bericht.dashboard_lesen', 'bericht', 'dashboard', 'lesen'::berechtigung_aktion, 'bericht.dashboard_lesen', false, 20),
  ('bericht.exportieren', 'bericht', 'bericht', 'exportieren'::berechtigung_aktion, 'bericht.exportieren', false, 21),
  ('bericht.lesen', 'bericht', 'bericht', 'lesen'::berechtigung_aktion, 'bericht.lesen', false, 22),
  ('buchhaltung_konfiguration.lesen', 'buchhaltung_konfiguration', 'buchhaltung_konfiguration', 'lesen'::berechtigung_aktion, 'buchhaltung_konfiguration.lesen', false, 23),
  ('buchhaltung_konfiguration.verwalten', 'buchhaltung_konfiguration', 'buchhaltung_konfiguration', 'verwalten'::berechtigung_aktion, 'buchhaltung_konfiguration.verwalten', false, 24),
  ('buchhaltung.exportieren', 'buchhaltung', 'buchhaltung', 'exportieren'::berechtigung_aktion, 'buchhaltung.exportieren', false, 25),
  ('buchhaltung.festschreiben', 'buchhaltung', 'buchhaltung', 'festschreiben'::berechtigung_aktion, 'buchhaltung.festschreiben', false, 26),
  ('buchhaltung.lesen', 'buchhaltung', 'buchhaltung', 'lesen'::berechtigung_aktion, 'buchhaltung.lesen', false, 27),
  ('buchhaltung.schreiben', 'buchhaltung', 'buchhaltung', 'schreiben'::berechtigung_aktion, 'buchhaltung.schreiben', false, 28),
  ('crm_entgelt.lesen', 'crm_entgelt', 'crm_entgelt', 'lesen'::berechtigung_aktion, 'crm_entgelt.lesen', false, 29),
  ('crm.exportieren', 'crm', 'crm', 'exportieren'::berechtigung_aktion, 'crm.exportieren', false, 30),
  ('crm.kommunikation_versenden', 'crm', 'kommunikation', 'versenden'::berechtigung_aktion, 'crm.kommunikation_versenden', false, 31),
  ('crm.rechtsgrundlage_lesen', 'crm', 'rechtsgrundlage', 'lesen'::berechtigung_aktion, 'crm.rechtsgrundlage_lesen', false, 32),
  ('crm.rechtsgrundlage_setzen', 'crm', 'rechtsgrundlage', 'setzen'::berechtigung_aktion, 'crm.rechtsgrundlage_setzen', false, 33),
  ('datenschutz.auskunft_erstellen', 'datenschutz', 'auskunft', 'erstellen'::berechtigung_aktion, 'datenschutz.auskunft_erstellen', false, 34),
  ('datenschutz.berichtigung_bearbeiten', 'datenschutz', 'berichtigung', 'bearbeiten'::berechtigung_aktion, 'datenschutz.berichtigung_bearbeiten', false, 35),
  ('datenschutz.loeschung_pruefen', 'datenschutz', 'loeschung', 'pruefen'::berechtigung_aktion, 'datenschutz.loeschung_pruefen', false, 36),
  ('dienstanweisung.lesen', 'dienstanweisung', 'dienstanweisung', 'lesen'::berechtigung_aktion, 'dienstanweisung.lesen', false, 37),
  ('dienstanweisung.schreiben', 'dienstanweisung', 'dienstanweisung', 'schreiben'::berechtigung_aktion, 'dienstanweisung.schreiben', false, 38),
  ('dienstplan.arbzg_lesen', 'dienstplan', 'arbzg', 'lesen'::berechtigung_aktion, 'dienstplan.arbzg_lesen', false, 39),
  ('dienstplan.arbzg_pruefen', 'dienstplan', 'arbzg', 'pruefen'::berechtigung_aktion, 'dienstplan.arbzg_pruefen', false, 40),
  ('dienstplan.arbzg_uebersteuern', 'dienstplan', 'arbzg', 'uebersteuern'::berechtigung_aktion, 'dienstplan.arbzg_uebersteuern', false, 41),
  ('dienstplan.konflikt_quittieren', 'dienstplan', 'konflikt', 'quittieren'::berechtigung_aktion, 'dienstplan.konflikt_quittieren', false, 42),
  ('dienstplan.lesen', 'dienstplan', 'dienstplan', 'lesen'::berechtigung_aktion, 'dienstplan.lesen', false, 43),
  ('dienstplan.schreiben', 'dienstplan', 'dienstplan', 'schreiben'::berechtigung_aktion, 'dienstplan.schreiben', false, 44),
  ('dienstplan.veroeffentlichen', 'dienstplan', 'dienstplan', 'veroeffentlichen'::berechtigung_aktion, 'dienstplan.veroeffentlichen', false, 45),
  ('dokument.archivieren', 'dokument', 'dokument', 'archivieren'::berechtigung_aktion, 'dokument.archivieren', false, 46),
  ('dokument.aufbewahrung_verwalten', 'dokument', 'aufbewahrung', 'verwalten'::berechtigung_aktion, 'dokument.aufbewahrung_verwalten', false, 47),
  ('dokument.buendel_exportieren', 'dokument', 'buendel', 'exportieren'::berechtigung_aktion, 'dokument.buendel_exportieren', false, 48),
  ('dokument.kunde_freigeben', 'dokument', 'kunde', 'freigeben'::berechtigung_aktion, 'dokument.kunde_freigeben', false, 49),
  ('dokument.lesen', 'dokument', 'dokument', 'lesen'::berechtigung_aktion, 'dokument.lesen', false, 50),
  ('dokument.schreiben', 'dokument', 'dokument', 'schreiben'::berechtigung_aktion, 'dokument.schreiben', false, 51),
  ('eingang.freigeben', 'eingang', 'eingang', 'freigeben'::berechtigung_aktion, 'eingang.freigeben', false, 52),
  ('eingang.lesen', 'eingang', 'eingang', 'lesen'::berechtigung_aktion, 'eingang.lesen', false, 53),
  ('eingang.schreiben', 'eingang', 'eingang', 'schreiben'::berechtigung_aktion, 'eingang.schreiben', false, 54),
  ('finanzen.entwurf_verwerfen', 'finanzen', 'entwurf', 'verwerfen'::berechtigung_aktion, 'finanzen.entwurf_verwerfen', false, 55),
  ('finanzen.festschreiben', 'finanzen', 'finanzen', 'festschreiben'::berechtigung_aktion, 'finanzen.festschreiben', false, 56),
  ('finanzen.herunterladen', 'finanzen', 'finanzen', 'herunterladen'::berechtigung_aktion, 'finanzen.herunterladen', false, 57),
  ('finanzen.lesen', 'finanzen', 'finanzen', 'lesen'::berechtigung_aktion, 'finanzen.lesen', false, 58),
  ('finanzen.schreiben', 'finanzen', 'finanzen', 'schreiben'::berechtigung_aktion, 'finanzen.schreiben', false, 59),
  ('finanzen.steuerfall_uebersteuern', 'finanzen', 'steuerfall', 'uebersteuern'::berechtigung_aktion, 'finanzen.steuerfall_uebersteuern', false, 60),
  ('finanzen.stornieren', 'finanzen', 'finanzen', 'stornieren'::berechtigung_aktion, 'finanzen.stornieren', false, 61),
  ('gruppe.abrechnung.lesen', 'gruppe', 'abrechnung', 'lesen'::berechtigung_aktion, 'gruppe.abrechnung.lesen', false, 62),
  ('gruppe.agent.lesen', 'gruppe', 'agent', 'lesen'::berechtigung_aktion, 'gruppe.agent.lesen', false, 63),
  ('gruppe.angebot.lesen', 'gruppe', 'angebot', 'lesen'::berechtigung_aktion, 'gruppe.angebot.lesen', false, 64),
  ('gruppe.aufgabe.lesen', 'gruppe', 'aufgabe', 'lesen'::berechtigung_aktion, 'gruppe.aufgabe.lesen', false, 65),
  ('gruppe.auftrag.lesen', 'gruppe', 'auftrag', 'lesen'::berechtigung_aktion, 'gruppe.auftrag.lesen', false, 66),
  ('gruppe.bau.lesen', 'gruppe', 'bau', 'lesen'::berechtigung_aktion, 'gruppe.bau.lesen', false, 67),
  ('gruppe.bericht.lesen', 'gruppe', 'bericht', 'lesen'::berechtigung_aktion, 'gruppe.bericht.lesen', false, 68),
  ('gruppe.buchhaltung_konfiguration.lesen', 'gruppe', 'buchhaltung_konfiguration', 'lesen'::berechtigung_aktion, 'gruppe.buchhaltung_konfiguration.lesen', false, 69),
  ('gruppe.buchhaltung.lesen', 'gruppe', 'buchhaltung', 'lesen'::berechtigung_aktion, 'gruppe.buchhaltung.lesen', false, 70),
  ('gruppe.crm_entgelt.lesen', 'gruppe', 'crm_entgelt', 'lesen'::berechtigung_aktion, 'gruppe.crm_entgelt.lesen', false, 71),
  ('gruppe.crm.lesen', 'gruppe', 'crm', 'lesen'::berechtigung_aktion, 'gruppe.crm.lesen', false, 72),
  ('gruppe.datenschutz.lesen', 'gruppe', 'datenschutz', 'lesen'::berechtigung_aktion, 'gruppe.datenschutz.lesen', false, 73),
  ('gruppe.dienstanweisung.lesen', 'gruppe', 'dienstanweisung', 'lesen'::berechtigung_aktion, 'gruppe.dienstanweisung.lesen', false, 74),
  ('gruppe.dienstplan.arbzg_lesen', 'gruppe', 'dienstplan_arbzg', 'lesen'::berechtigung_aktion, 'gruppe.dienstplan.arbzg_lesen', false, 75),
  ('gruppe.dienstplan.lesen', 'gruppe', 'dienstplan', 'lesen'::berechtigung_aktion, 'gruppe.dienstplan.lesen', false, 76),
  ('gruppe.dokument.lesen', 'gruppe', 'dokument', 'lesen'::berechtigung_aktion, 'gruppe.dokument.lesen', false, 77),
  ('gruppe.eingang.lesen', 'gruppe', 'eingang', 'lesen'::berechtigung_aktion, 'gruppe.eingang.lesen', false, 78),
  ('gruppe.finanzen.lesen', 'gruppe', 'finanzen', 'lesen'::berechtigung_aktion, 'gruppe.finanzen.lesen', false, 79),
  ('gruppe.formular.lesen', 'gruppe', 'formular', 'lesen'::berechtigung_aktion, 'gruppe.formular.lesen', false, 80),
  ('gruppe.freigabe.lesen', 'gruppe', 'freigabe', 'lesen'::berechtigung_aktion, 'gruppe.freigabe.lesen', false, 81),
  ('gruppe.kalender.lesen', 'gruppe', 'kalender', 'lesen'::berechtigung_aktion, 'gruppe.kalender.lesen', false, 82),
  ('gruppe.kalkulation.lesen', 'gruppe', 'kalkulation', 'lesen'::berechtigung_aktion, 'gruppe.kalkulation.lesen', false, 83),
  ('gruppe.katalog.lesen', 'gruppe', 'katalog', 'lesen'::berechtigung_aktion, 'gruppe.katalog.lesen', false, 84),
  ('gruppe.mahnung.lesen', 'gruppe', 'mahnung', 'lesen'::berechtigung_aktion, 'gruppe.mahnung.lesen', false, 85),
  ('gruppe.nachricht.lesen', 'gruppe', 'nachricht', 'lesen'::berechtigung_aktion, 'gruppe.nachricht.lesen', false, 86),
  ('gruppe.nachweis.lesen', 'gruppe', 'nachweis', 'lesen'::berechtigung_aktion, 'gruppe.nachweis.lesen', false, 87),
  ('gruppe.nummernkreis.lesen', 'gruppe', 'nummernkreis', 'lesen'::berechtigung_aktion, 'gruppe.nummernkreis.lesen', false, 88),
  ('gruppe.objekt_import.lesen', 'gruppe', 'objekt_import', 'lesen'::berechtigung_aktion, 'gruppe.objekt_import.lesen', false, 89),
  ('gruppe.objekt.lesen', 'gruppe', 'objekt', 'lesen'::berechtigung_aktion, 'gruppe.objekt.lesen', false, 90),
  ('gruppe.oeffentlich.lesen', 'gruppe', 'oeffentlich', 'lesen'::berechtigung_aktion, 'gruppe.oeffentlich.lesen', false, 91),
  ('gruppe.personal.lesen', 'gruppe', 'personal', 'lesen'::berechtigung_aktion, 'gruppe.personal.lesen', false, 92),
  ('gruppe.qualitaet.lesen', 'gruppe', 'qualitaet', 'lesen'::berechtigung_aktion, 'gruppe.qualitaet.lesen', false, 93),
  ('gruppe.radar.lesen', 'gruppe', 'radar', 'lesen'::berechtigung_aktion, 'gruppe.radar.lesen', false, 94),
  ('gruppe.recruiting.lesen', 'gruppe', 'recruiting', 'lesen'::berechtigung_aktion, 'gruppe.recruiting.lesen', false, 95),
  ('gruppe.referenz.lesen', 'gruppe', 'referenz', 'lesen'::berechtigung_aktion, 'gruppe.referenz.lesen', false, 96),
  ('gruppe.reinigung.lesen', 'gruppe', 'reinigung', 'lesen'::berechtigung_aktion, 'gruppe.reinigung.lesen', false, 97),
  ('gruppe.schluessel.lesen', 'gruppe', 'schluessel', 'lesen'::berechtigung_aktion, 'gruppe.schluessel.lesen', false, 98),
  ('gruppe.security.lesen', 'gruppe', 'security', 'lesen'::berechtigung_aktion, 'gruppe.security.lesen', false, 99),
  ('gruppe.social.lesen', 'gruppe', 'social', 'lesen'::berechtigung_aktion, 'gruppe.social.lesen', false, 100),
  ('gruppe.stammdaten.lesen', 'gruppe', 'stammdaten', 'lesen'::berechtigung_aktion, 'gruppe.stammdaten.lesen', false, 101),
  ('gruppe.system.audit_lesen', 'gruppe', 'system_audit', 'lesen'::berechtigung_aktion, 'gruppe.system.audit_lesen', false, 102),
  ('gruppe.system.lesen', 'gruppe', 'system', 'lesen'::berechtigung_aktion, 'gruppe.system.lesen', false, 103),
  ('gruppe.vergabe.lesen', 'gruppe', 'vergabe', 'lesen'::berechtigung_aktion, 'gruppe.vergabe.lesen', false, 104),
  ('gruppe.versand.lesen', 'gruppe', 'versand', 'lesen'::berechtigung_aktion, 'gruppe.versand.lesen', false, 105),
  ('gruppe.wachbuch.lesen', 'gruppe', 'wachbuch', 'lesen'::berechtigung_aktion, 'gruppe.wachbuch.lesen', false, 106),
  ('gruppe.wissen.lesen', 'gruppe', 'wissen', 'lesen'::berechtigung_aktion, 'gruppe.wissen.lesen', false, 107),
  ('gruppe.zahlung.lesen', 'gruppe', 'zahlung', 'lesen'::berechtigung_aktion, 'gruppe.zahlung.lesen', false, 108),
  ('gruppe.zeit.lesen', 'gruppe', 'zeit', 'lesen'::berechtigung_aktion, 'gruppe.zeit.lesen', false, 109),
  ('kalender.lesen', 'kalender', 'kalender', 'lesen'::berechtigung_aktion, 'kalender.lesen', false, 110),
  ('kalender.schreiben', 'kalender', 'kalender', 'schreiben'::berechtigung_aktion, 'kalender.schreiben', false, 111),
  ('katalog.lesen', 'katalog', 'katalog', 'lesen'::berechtigung_aktion, 'katalog.lesen', false, 112),
  ('katalog.schreiben', 'katalog', 'katalog', 'schreiben'::berechtigung_aktion, 'katalog.schreiben', false, 113),
  ('mahnung.freigeben', 'mahnung', 'mahnung', 'freigeben'::berechtigung_aktion, 'mahnung.freigeben', false, 114),
  ('mahnung.lesen', 'mahnung', 'mahnung', 'lesen'::berechtigung_aktion, 'mahnung.lesen', false, 115),
  ('mahnung.schreiben', 'mahnung', 'mahnung', 'schreiben'::berechtigung_aktion, 'mahnung.schreiben', false, 116),
  ('nachricht.lesen', 'nachricht', 'nachricht', 'lesen'::berechtigung_aktion, 'nachricht.lesen', false, 117),
  ('nachricht.versenden', 'nachricht', 'nachricht', 'versenden'::berechtigung_aktion, 'nachricht.versenden', false, 118),
  ('nachweis.lesen', 'nachweis', 'nachweis', 'lesen'::berechtigung_aktion, 'nachweis.lesen', false, 119),
  ('nachweis.preis_lesen', 'nachweis', 'preis', 'lesen'::berechtigung_aktion, 'nachweis.preis_lesen', false, 120),
  ('nachweis.schreiben', 'nachweis', 'nachweis', 'schreiben'::berechtigung_aktion, 'nachweis.schreiben', false, 121),
  ('nummernkreis.lesen', 'nummernkreis', 'nummernkreis', 'lesen'::berechtigung_aktion, 'nummernkreis.lesen', false, 122),
  ('nummernkreis.verwalten', 'nummernkreis', 'nummernkreis', 'verwalten'::berechtigung_aktion, 'nummernkreis.verwalten', false, 123),
  ('nummernkreis.ziehen', 'nummernkreis', 'nummernkreis', 'ziehen'::berechtigung_aktion, 'nummernkreis.ziehen', false, 124),
  ('objekt.lesen', 'objekt', 'objekt', 'lesen'::berechtigung_aktion, 'objekt.lesen', false, 125),
  ('objekt.schreiben', 'objekt', 'objekt', 'schreiben'::berechtigung_aktion, 'objekt.schreiben', false, 126),
  ('oeffentlich.lesen', 'oeffentlich', 'oeffentlich', 'lesen'::berechtigung_aktion, 'oeffentlich.lesen', false, 127),
  ('personal.anstellung_beenden', 'personal', 'anstellung', 'beenden'::berechtigung_aktion, 'personal.anstellung_beenden', false, 128),
  ('personal.bewacher_verwalten', 'personal', 'bewacher', 'verwalten'::berechtigung_aktion, 'personal.bewacher_verwalten', false, 129),
  ('personal.entgelt_lesen', 'personal', 'entgelt', 'lesen'::berechtigung_aktion, 'personal.entgelt_lesen', false, 130),
  ('personal.entgelt_schreiben', 'personal', 'entgelt', 'schreiben'::berechtigung_aktion, 'personal.entgelt_schreiben', false, 131),
  ('personal.erstattung_lesen', 'personal', 'erstattung', 'lesen'::berechtigung_aktion, 'personal.erstattung_lesen', false, 132),
  ('personal.lesen', 'personal', 'personal', 'lesen'::berechtigung_aktion, 'personal.lesen', false, 133),
  ('personal.stammdaten_lesen', 'personal', 'stammdaten', 'lesen'::berechtigung_aktion, 'personal.stammdaten_lesen', false, 134),
  ('personal.zugang_verwalten', 'personal', 'zugang', 'verwalten'::berechtigung_aktion, 'personal.zugang_verwalten', false, 135),
  ('personal.zusammenfuehren', 'personal', 'personal', 'zusammenfuehren'::berechtigung_aktion, 'personal.zusammenfuehren', false, 136),
  ('qualitaet.lesen', 'qualitaet', 'qualitaet', 'lesen'::berechtigung_aktion, 'qualitaet.lesen', false, 137),
  ('qualitaet.schreiben', 'qualitaet', 'qualitaet', 'schreiben'::berechtigung_aktion, 'qualitaet.schreiben', false, 138),
  ('radar.lesen', 'radar', 'radar', 'lesen'::berechtigung_aktion, 'radar.lesen', false, 139),
  ('radar.plattform_verwalten', 'radar', 'plattform', 'verwalten'::berechtigung_aktion, 'radar.plattform_verwalten', false, 140),
  ('radar.profil_schreiben', 'radar', 'profil', 'schreiben'::berechtigung_aktion, 'radar.profil_schreiben', false, 141),
  ('radar.status_setzen', 'radar', 'status', 'setzen'::berechtigung_aktion, 'radar.status_setzen', false, 142),
  ('recruiting.bewerbung_bewerten', 'recruiting', 'bewerbung', 'bewerten'::berechtigung_aktion, 'recruiting.bewerbung_bewerten', false, 143),
  ('recruiting.bewerbung_lesen', 'recruiting', 'bewerbung', 'lesen'::berechtigung_aktion, 'recruiting.bewerbung_lesen', false, 144),
  ('recruiting.daten_loeschen', 'recruiting', 'daten', 'loeschen'::berechtigung_aktion, 'recruiting.daten_loeschen', false, 145),
  ('recruiting.entscheiden', 'recruiting', 'recruiting', 'entscheiden'::berechtigung_aktion, 'recruiting.entscheiden', false, 146),
  ('recruiting.stelle_lesen', 'recruiting', 'stelle', 'lesen'::berechtigung_aktion, 'recruiting.stelle_lesen', false, 147),
  ('recruiting.stelle_schreiben', 'recruiting', 'stelle', 'schreiben'::berechtigung_aktion, 'recruiting.stelle_schreiben', false, 148),
  ('recruiting.stelle_veroeffentlichen', 'recruiting', 'stelle', 'veroeffentlichen'::berechtigung_aktion, 'recruiting.stelle_veroeffentlichen', false, 149),
  ('referenz.kundenfreigabe_erfassen', 'referenz', 'kundenfreigabe', 'erfassen'::berechtigung_aktion, 'referenz.kundenfreigabe_erfassen', false, 150),
  ('referenz.lesen', 'referenz', 'referenz', 'lesen'::berechtigung_aktion, 'referenz.lesen', false, 151),
  ('referenz.schreiben', 'referenz', 'referenz', 'schreiben'::berechtigung_aktion, 'referenz.schreiben', false, 152),
  ('referenz.veroeffentlichen', 'referenz', 'referenz', 'veroeffentlichen'::berechtigung_aktion, 'referenz.veroeffentlichen', false, 153),
  ('schluessel.lesen', 'schluessel', 'schluessel', 'lesen'::berechtigung_aktion, 'schluessel.lesen', false, 154),
  ('schluessel.schreiben', 'schluessel', 'schluessel', 'schreiben'::berechtigung_aktion, 'schluessel.schreiben', false, 155),
  ('security.lesen', 'security', 'security', 'lesen'::berechtigung_aktion, 'security.lesen', false, 156),
  ('security.schreiben', 'security', 'security', 'schreiben'::berechtigung_aktion, 'security.schreiben', false, 157),
  ('social.freigeben', 'social', 'social', 'freigeben'::berechtigung_aktion, 'social.freigeben', false, 158),
  ('social.kanal_verbinden', 'social', 'kanal', 'verbinden'::berechtigung_aktion, 'social.kanal_verbinden', false, 159),
  ('social.lesen', 'social', 'social', 'lesen'::berechtigung_aktion, 'social.lesen', false, 160),
  ('social.planen', 'social', 'social', 'planen'::berechtigung_aktion, 'social.planen', false, 161),
  ('social.schreiben', 'social', 'social', 'schreiben'::berechtigung_aktion, 'social.schreiben', false, 162),
  ('stammdaten.verwalten', 'stammdaten', 'stammdaten', 'verwalten'::berechtigung_aktion, 'stammdaten.verwalten', false, 163),
  ('system.audit_exportieren', 'system', 'audit', 'exportieren'::berechtigung_aktion, 'system.audit_exportieren', false, 164),
  ('system.audit_lesen', 'system', 'audit', 'lesen'::berechtigung_aktion, 'system.audit_lesen', false, 165),
  ('system.audit_sensitiv_lesen', 'system', 'audit_sensitiv', 'lesen'::berechtigung_aktion, 'system.audit_sensitiv_lesen', false, 166),
  ('system.benutzer_lesen', 'system', 'benutzer', 'lesen'::berechtigung_aktion, 'system.benutzer_lesen', false, 167),
  ('system.benutzer_verwalten', 'system', 'benutzer', 'verwalten'::berechtigung_aktion, 'system.benutzer_verwalten', false, 168),
  ('system.betrieb_lesen', 'system', 'betrieb', 'lesen'::berechtigung_aktion, 'system.betrieb_lesen', false, 169),
  ('system.einstellung_lesen', 'system', 'einstellung', 'lesen'::berechtigung_aktion, 'system.einstellung_lesen', false, 170),
  ('system.einstellung_verwalten', 'system', 'einstellung', 'verwalten'::berechtigung_aktion, 'system.einstellung_verwalten', false, 171),
  ('system.feed_token_widerrufen', 'system', 'feed_token', 'widerrufen'::berechtigung_aktion, 'system.feed_token_widerrufen', false, 172),
  ('system.identitaet_verwalten', 'system', 'identitaet', 'verwalten'::berechtigung_aktion, 'system.identitaet_verwalten', false, 173),
  ('system.mandant_lesen', 'system', 'mandant', 'lesen'::berechtigung_aktion, 'system.mandant_lesen', false, 174),
  ('system.mandant_verwalten', 'system', 'mandant', 'verwalten'::berechtigung_aktion, 'system.mandant_verwalten', true, 175),
  ('system.module_zuweisen', 'system', 'module', 'zuweisen'::berechtigung_aktion, 'system.module_zuweisen', false, 176),
  ('system.protokoll_lesen', 'system', 'protokoll', 'lesen'::berechtigung_aktion, 'system.protokoll_lesen', false, 177),
  ('system.referenzdaten_verwalten', 'system', 'referenzdaten', 'verwalten'::berechtigung_aktion, 'system.referenzdaten_verwalten', false, 178),
  ('system.rolle_lesen', 'system', 'rolle', 'lesen'::berechtigung_aktion, 'system.rolle_lesen', false, 179),
  ('system.rolle_verwalten', 'system', 'rolle', 'verwalten'::berechtigung_aktion, 'system.rolle_verwalten', false, 180),
  ('system.sitzung_lesen', 'system', 'sitzung', 'lesen'::berechtigung_aktion, 'system.sitzung_lesen', false, 181),
  ('system.sitzung_widerrufen', 'system', 'sitzung', 'widerrufen'::berechtigung_aktion, 'system.sitzung_widerrufen', false, 182),
  ('system.zwei_faktor_zuruecksetzen', 'system', 'zwei_faktor', 'zuruecksetzen'::berechtigung_aktion, 'system.zwei_faktor_zuruecksetzen', true, 183),
  ('vergabe.einreichung_erfassen', 'vergabe', 'einreichung', 'erfassen'::berechtigung_aktion, 'vergabe.einreichung_erfassen', false, 184),
  ('versand.freigeben', 'versand', 'versand', 'freigeben'::berechtigung_aktion, 'versand.freigeben', false, 185),
  ('versand.lesen', 'versand', 'versand', 'lesen'::berechtigung_aktion, 'versand.lesen', false, 186),
  ('wachbuch.lesen', 'wachbuch', 'wachbuch', 'lesen'::berechtigung_aktion, 'wachbuch.lesen', false, 187),
  ('wachbuch.schreiben', 'wachbuch', 'wachbuch', 'schreiben'::berechtigung_aktion, 'wachbuch.schreiben', false, 188),
  ('zahlung.lesen', 'zahlung', 'zahlung', 'lesen'::berechtigung_aktion, 'zahlung.lesen', false, 189),
  ('zahlung.schreiben', 'zahlung', 'zahlung', 'schreiben'::berechtigung_aktion, 'zahlung.schreiben', false, 190),
  ('zeit.abrechnung_freigeben', 'zeit', 'abrechnung', 'freigeben'::berechtigung_aktion, 'zeit.abrechnung_freigeben', false, 191),
  ('zeit.abwesenheit_genehmigen', 'zeit', 'abwesenheit', 'genehmigen'::berechtigung_aktion, 'zeit.abwesenheit_genehmigen', false, 192),
  ('zeit.abwesenheit_grund_lesen', 'zeit', 'abwesenheit_grund', 'lesen'::berechtigung_aktion, 'zeit.abwesenheit_grund_lesen', false, 193),
  ('zeit.abwesenheit_lesen', 'zeit', 'abwesenheit', 'lesen'::berechtigung_aktion, 'zeit.abwesenheit_lesen', false, 194),
  ('zeit.abwesenheit_melden', 'zeit', 'abwesenheit', 'melden'::berechtigung_aktion, 'zeit.abwesenheit_melden', false, 195),
  ('zeit.antrag_entscheiden', 'zeit', 'antrag', 'entscheiden'::berechtigung_aktion, 'zeit.antrag_entscheiden', false, 196),
  ('zeit.checkin_verwalten', 'zeit', 'checkin', 'verwalten'::berechtigung_aktion, 'zeit.checkin_verwalten', false, 197),
  ('zeit.einwand_entscheiden', 'zeit', 'einwand', 'entscheiden'::berechtigung_aktion, 'zeit.einwand_entscheiden', false, 198),
  ('zeit.exportieren', 'zeit', 'zeit', 'exportieren'::berechtigung_aktion, 'zeit.exportieren', false, 199),
  ('zeit.konto_abschliessen', 'zeit', 'konto', 'abschliessen'::berechtigung_aktion, 'zeit.konto_abschliessen', false, 200),
  ('zeit.konto_korrigieren', 'zeit', 'konto', 'korrigieren'::berechtigung_aktion, 'zeit.konto_korrigieren', false, 201),
  ('zeit.konto_lesen', 'zeit', 'konto', 'lesen'::berechtigung_aktion, 'zeit.konto_lesen', false, 202),
  ('zeit.korrigieren', 'zeit', 'zeit', 'korrigieren'::berechtigung_aktion, 'zeit.korrigieren', false, 203),
  ('zeit.lesen', 'zeit', 'zeit', 'lesen'::berechtigung_aktion, 'zeit.lesen', false, 204),
  ('zeit.nacherfassung_pruefen', 'zeit', 'nacherfassung', 'pruefen'::berechtigung_aktion, 'zeit.nacherfassung_pruefen', false, 205),
  ('zeit.schreiben', 'zeit', 'zeit', 'schreiben'::berechtigung_aktion, 'zeit.schreiben', false, 206);
