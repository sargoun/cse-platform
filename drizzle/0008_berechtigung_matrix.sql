...
insert into berechtigung (schluessel, modul, objekt, aktion, bezeichnung, nur_global, sortierung) values
  ...
  ('angebot.annahme_erfassen', 'angebot', 'annahme', 'erfassen'::berechtigung_aktion, 'angebot.annahme_erfassen', false, 3),
  ('angebot.lesen', 'angebot', 'angebot', 'lesen'::berechtigung_aktion, 'angebot.lesen', false, 4),
  ('angebot.preis_freigeben', 'angebot', 'preis', 'freigeben'::berechtigung_aktion, 'angebot.preis_freigeben', false, 5),
  ('angebot.schreiben', 'angebot', 'angebot', 'schreiben'::berechtigung_aktion, 'angebot.schreiben', false, 6),
  ('angebot.versenden', 'angebot', 'angebot', 'versenden'::berechtigung_aktion, 'angebot.versenden', false, 7),
  ('aufgabe.lesen', 'aufgabe', 'aufgabe', 'lesen'::berechtigung_aktion, 'aufgabe.lesen', false, 8),
  ('aufgabe.schreiben', 'aufgabe', 'aufgabe', 'schreiben'::berechtigung_aktion, 'aufgabe.schreiben', false, 9),
  ('aufgabe.zuweisen', 'aufgabe', 'aufgabe', 'zuweisen'::berechtigung_aktion, 'aufgabe.zuweisen', false, 10),
  ('auftrag.abschliessen', 'auftrag', 'auftrag', 'abschliessen'::berechtigung_aktion, 'auftrag.abschliessen', false, 11),
  ('auftrag.lesen', 'auftrag', 'auftrag', 'lesen'::berechtigung_aktion, 'auftrag.lesen', false, 12),
  ('auftrag.schreiben', 'auftrag', 'auftrag', 'schreiben'::berechtigung_aktion, 'auftrag.schreiben', false, 13),
  ('bau.aufmass_erfassen', 'bau', 'aufmass', 'erfassen'::berechtigung_aktion, 'bau.aufmass_erfassen', false, 14),
  ('bau.aufmass_freigeben', 'bau', 'aufmass', 'freigeben'::berechtigung_aktion, 'bau.aufmass_freigeben', false, 15),
  ('bau.behinderung_erstellen', 'bau', 'behinderung', 'erstellen'::berechtigung_aktion, 'bau.behinderung_erstellen', false, 16),
  ('bau.lesen', 'bau', 'bau', 'lesen'::berechtigung_aktion, 'bau.lesen', false, 17),
  ('bau.nachtrag_anmelden', 'bau', 'nachtrag', 'anmelden'::berechtigung_aktion, 'bau.nachtrag_anmelden', false, 18),
  ('bau.nachtrag_einreichen', 'bau', 'nachtrag', 'einreichen'::berechtigung_aktion, 'bau.nachtrag_einreichen', false, 19),
  ('bau.preis_lesen', 'bau', 'preis', 'lesen'::berechtigung_aktion, 'bau.preis_lesen', false, 20),
  ('bau.schreiben', 'bau', 'bau', 'schreiben'::berechtigung_aktion, 'bau.schreiben', false, 21),
  ('bericht.dashboard_lesen', 'bericht', 'dashboard', 'lesen'::berechtigung_aktion, 'bericht.dashboard_lesen', false, 22),
  ('bericht.exportieren', 'bericht', 'bericht', 'exportieren'::berechtigung_aktion, 'bericht.exportieren', false, 23),
  ('bericht.lesen', 'bericht', 'bericht', 'lesen'::berechtigung_aktion, 'bericht.lesen', false, 24),
  ('buchhaltung_konfiguration.lesen', 'buchhaltung_konfiguration', 'buchhaltung_konfiguration', 'lesen'::berechtigung_aktion, 'buchhaltung_konfiguration.lesen', false, 25),
  ('buchhaltung_konfiguration.verwalten', 'buchhaltung_konfiguration', 'buchhaltung_konfiguration', 'verwalten'::berechtigung_aktion, 'buchhaltung_konfiguration.verwalten', false, 26),
  ('buchhaltung.exportieren', 'buchhaltung', 'buchhaltung', 'exportieren'::berechtigung_aktion, 'buchhaltung.exportieren', false, 27),
  ('buchhaltung.festschreiben', 'buchhaltung', 'buchhaltung', 'festschreiben'::berechtigung_aktion, 'buchhaltung.festschreiben', false, 28),
  ('buchhaltung.lesen', 'buchhaltung', 'buchhaltung', 'lesen'::berechtigung_aktion, 'buchhaltung.lesen', false, 29),
  ('buchhaltung.schreiben', 'buchhaltung', 'buchhaltung', 'schreiben'::berechtigung_aktion, 'buchhaltung.schreiben', false, 30),
  ('crm_entgelt.lesen', 'crm_entgelt', 'crm_entgelt', 'lesen'::berechtigung_aktion, 'crm_entgelt.lesen', false, 31),
  ('crm.exportieren', 'crm', 'crm', 'exportieren'::berechtigung_aktion, 'crm.exportieren', false, 32),
  ('crm.kommunikation_versenden', 'crm', 'kommunikation', 'versenden'::berechtigung_aktion, 'crm.kommunikation_versenden', false, 33),
  ('crm.lesen', 'crm', 'crm', 'lesen'::berechtigung_aktion, 'crm.lesen', false, 34),
  ('crm.rechtsgrundlage_lesen', 'crm', 'rechtsgrundlage', 'lesen'::berechtigung_aktion, 'crm.rechtsgrundlage_lesen', false, 35),
  ('crm.rechtsgrundlage_setzen', 'crm', 'rechtsgrundlage', 'setzen'::berechtigung_aktion, 'crm.rechtsgrundlage_setzen', false, 36),
  ('crm.schreiben', 'crm', 'crm', 'schreiben'::berechtigung_aktion, 'crm.schreiben', false, 37),
  ('datenschutz.auskunft_erstellen', 'datenschutz', 'auskunft', 'erstellen'::berechtigung_aktion, 'datenschutz.auskunft_erstellen', false, 38),
  ('datenschutz.berichtigung_bearbeiten', 'datenschutz', 'berichtigung', 'bearbeiten'::berechtigung_aktion, 'datenschutz.berichtigung_bearbeiten', false, 39),
  ('datenschutz.loeschung_pruefen', 'datenschutz', 'loeschung', 'pruefen'::berechtigung_aktion, 'datenschutz.loeschung_pruefen', false, 40),
  ('dienstanweisung.lesen', 'dienstanweisung', 'dienstanweisung', 'lesen'::berechtigung_aktion, 'dienstanweisung.lesen', false, 41),
  ('dienstanweisung.schreiben', 'dienstanweisung', 'dienstanweisung', 'schreiben'::berechtigung_aktion, 'dienstanweisung.schreiben', false, 42),
  ('dienstplan.arbzg_lesen', 'dienstplan', 'arbzg', 'lesen'::berechtigung_aktion, 'dienstplan.arbzg_lesen', false, 43),
  ('dienstplan.arbzg_pruefen', 'dienstplan', 'arbzg', 'pruefen'::berechtigung_aktion, 'dienstplan.arbzg_pruefen', false, 44),
  ('dienstplan.arbzg_uebersteuern', 'dienstplan', 'arbzg', 'uebersteuern'::berechtigung_aktion, 'dienstplan.arbzg_uebersteuern', false, 45),
  ('dienstplan.konflikt_quittieren', 'dienstplan', 'konflikt', 'quittieren'::berechtigung_aktion, 'dienstplan.konflikt_quittieren', false, 46),
  ('dienstplan.lesen', 'dienstplan', 'dienstplan', 'lesen'::berechtigung_aktion, 'dienstplan.lesen', false, 47),
  ('dienstplan.schreiben', 'dienstplan', 'dienstplan', 'schreiben'::berechtigung_aktion, 'dienstplan.schreiben', false, 48),
  ('dienstplan.veroeffentlichen', 'dienstplan', 'dienstplan', 'veroeffentlichen'::berechtigung_aktion, 'dienstplan.veroeffentlichen', false, 49),
  ('dokument.archivieren', 'dokument', 'dokument', 'archivieren'::berechtigung_aktion, 'dokument.archivieren', false, 50),
  ('dokument.aufbewahrung_verwalten', 'dokument', 'aufbewahrung', 'verwalten'::berechtigung_aktion, 'dokument.aufbewahrung_verwalten', false, 51),
  ('dokument.buendel_exportieren', 'dokument', 'buendel', 'exportieren'::berechtigung_aktion, 'dokument.buendel_exportieren', false, 52),
  ('dokument.kunde_freigeben', 'dokument', 'kunde', 'freigeben'::berechtigung_aktion, 'dokument.kunde_freigeben', false, 53),
  ('dokument.lesen', 'dokument', 'dokument', 'lesen'::berechtigung_aktion, 'dokument.lesen', false, 54),
  ('dokument.schreiben', 'dokument', 'dokument', 'schreiben'::berechtigung_aktion, 'dokument.schreiben', false, 55),
  ('eingang.freigeben', 'eingang', 'eingang', 'freigeben'::berechtigung_aktion, 'eingang.freigeben', false, 56),
  ('eingang.lesen', 'eingang', 'eingang', 'lesen'::berechtigung_aktion, 'eingang.lesen', false, 57),
  ('eingang.schreiben', 'eingang', 'eingang', 'schreiben'::berechtigung_aktion, 'eingang.schreiben', false, 58),
  ('finanzen.entwurf_verwerfen', 'finanzen', 'entwurf', 'verwerfen'::berechtigung_aktion, 'finanzen.entwurf_verwerfen', false, 59),
  ('finanzen.festschreiben', 'finanzen', 'finanzen', 'festschreiben'::berechtigung_aktion, 'finanzen.festschreiben', false, 60),
  ('finanzen.herunterladen', 'finanzen', 'finanzen', 'herunterladen'::berechtigung_aktion, 'finanzen.herunterladen', false, 61),
  ('finanzen.lesen', 'finanzen', 'finanzen', 'lesen'::berechtigung_aktion, 'finanzen.lesen', false, 62),
  ('finanzen.schreiben', 'finanzen', 'finanzen', 'schreiben'::berechtigung_aktion, 'finanzen.schreiben', false, 63),
  ('finanzen.steuerfall_uebersteuern', 'finanzen', 'steuerfall', 'uebersteuern'::berechtigung_aktion, 'finanzen.steuerfall_uebersteuern', false, 64),
  ('finanzen.stornieren', 'finanzen', 'finanzen', 'stornieren'::berechtigung_aktion, 'finanzen.stornieren', false, 65),
  ('formular.lesen', 'formular', 'formular', 'lesen'::berechtigung_aktion, 'formular.lesen', false, 66),
  ('formular.schreiben', 'formular', 'formular', 'schreiben'::berechtigung_aktion, 'formular.schreiben', false, 67),
  ('gruppe.abrechnung.lesen', 'gruppe', 'abrechnung', 'lesen'::berechtigung_aktion, 'gruppe.abrechnung.lesen', false, 68),
  ('gruppe.agent.lesen', 'gruppe', 'agent', 'lesen'::berechtigung_aktion, 'gruppe.agent.lesen', false, 69),
  ('gruppe.angebot.lesen', 'gruppe', 'angebot', 'lesen'::berechtigung_aktion, 'gruppe.angebot.lesen', false, 70),
  ('gruppe.aufgabe.lesen', 'gruppe', 'aufgabe', 'lesen'::berechtigung_aktion, 'gruppe.aufgabe.lesen', false, 71),
  ('gruppe.auftrag.lesen', 'gruppe', 'auftrag', 'lesen'::berechtigung_aktion, 'gruppe.auftrag.lesen', false, 72),
  ('gruppe.bau.lesen', 'gruppe', 'bau', 'lesen'::berechtigung_aktion, 'gruppe.bau.lesen', false, 73),
  ('gruppe.bericht.lesen', 'gruppe', 'bericht', 'lesen'::berechtigung_aktion, 'gruppe.bericht.lesen', false, 74),
  ('gruppe.buchhaltung_konfiguration.lesen', 'gruppe', 'buchhaltung_konfiguration', 'lesen'::berechtigung_aktion, 'gruppe.buchhaltung_konfiguration.lesen', false, 75),
  ('gruppe.buchhaltung.lesen', 'gruppe', 'buchhaltung', 'lesen'::berechtigung_aktion, 'gruppe.buchhaltung.lesen', false, 76),
  ('gruppe.crm_entgelt.lesen', 'gruppe', 'crm_entgelt', 'lesen'::berechtigung_aktion, 'gruppe.crm_entgelt.lesen', false, 77),
  ('gruppe.crm.lesen', 'gruppe', 'crm', 'lesen'::berechtigung_aktion, 'gruppe.crm.lesen', false, 78),
  ('gruppe.datenschutz.lesen', 'gruppe', 'datenschutz', 'lesen'::berechtigung_aktion, 'gruppe.datenschutz.lesen', false, 79),
  ('gruppe.dienstanweisung.lesen', 'gruppe', 'dienstanweisung', 'lesen'::berechtigung_aktion, 'gruppe.dienstanweisung.lesen', false, 80),
  ('gruppe.dienstplan.arbzg_lesen', 'gruppe', 'dienstplan_arbzg', 'lesen'::berechtigung_aktion, 'gruppe.dienstplan.arbzg_lesen', false, 81),
  ('gruppe.dienstplan.lesen', 'gruppe', 'dienstplan', 'lesen'::berechtigung_aktion, 'gruppe.dienstplan.lesen', false, 82),
  ('gruppe.dokument.lesen', 'gruppe', 'dokument', 'lesen'::berechtigung_aktion, 'gruppe.dokument.lesen', false, 83),
  ('gruppe.eingang.lesen', 'gruppe', 'eingang', 'lesen'::berechtigung_aktion, 'gruppe.eingang.lesen', false, 84),
  ('gruppe.finanzen.lesen', 'gruppe', 'finanzen', 'lesen'::berechtigung_aktion, 'gruppe.finanzen.lesen', false, 85),
  ('gruppe.formular.lesen', 'gruppe', 'formular', 'lesen'::berechtigung_aktion, 'gruppe.formular.lesen', false, 86),
  ('gruppe.freigabe.lesen', 'gruppe', 'freigabe', 'lesen'::berechtigung_aktion, 'gruppe.freigabe.lesen', false, 87),
  ('gruppe.kalender.lesen', 'gruppe', 'kalender', 'lesen'::berechtigung_aktion, 'gruppe.kalender.lesen', false, 88),
  ('gruppe.kalkulation.lesen', 'gruppe', 'kalkulation', 'lesen'::berechtigung_aktion, 'gruppe.kalkulation.lesen', false, 89),
  ('gruppe.katalog.lesen', 'gruppe', 'katalog', 'lesen'::berechtigung_aktion, 'gruppe.katalog.lesen', false, 90),
  ('gruppe.mahnung.lesen', 'gruppe', 'mahnung', 'lesen'::berechtigung_aktion, 'gruppe.mahnung.lesen', false, 91),
  ('gruppe.nachricht.lesen', 'gruppe', 'nachricht', 'lesen'::berechtigung_aktion, 'gruppe.nachricht.lesen', false, 92),
  ('gruppe.nachweis.lesen', 'gruppe', 'nachweis', 'lesen'::berechtigung_aktion, 'gruppe.nachweis.lesen', false, 93),
  ('gruppe.nummernkreis.lesen', 'gruppe', 'nummernkreis', 'lesen'::berechtigung_aktion, 'gruppe.nummernkreis.lesen', false, 94),
  ('gruppe.objekt_import.lesen', 'gruppe', 'objekt_import', 'lesen'::berechtigung_aktion, 'gruppe.objekt_import.lesen', false, 95),
  ('gruppe.objekt.lesen', 'gruppe', 'objekt', 'lesen'::berechtigung_aktion, 'gruppe.objekt.lesen', false, 96),
  ('gruppe.oeffentlich.lesen', 'gruppe', 'oeffentlich', 'lesen'::berechtigung_aktion, 'gruppe.oeffentlich.lesen', false, 97),
  ('gruppe.personal.lesen', 'gruppe', 'personal', 'lesen'::berechtigung_aktion, 'gruppe.personal.lesen', false, 98),
  ('gruppe.qualitaet.lesen', 'gruppe', 'qualitaet', 'lesen'::berechtigung_aktion, 'gruppe.qualitaet.lesen', false, 99),
  ('gruppe.radar.lesen', 'gruppe', 'radar', 'lesen'::berechtigung_aktion, 'gruppe.radar.lesen', false, 100),
  ('gruppe.recruiting.lesen', 'gruppe', 'recruiting', 'lesen'::berechtigung_aktion, 'gruppe.recruiting.lesen', false, 101),
  ('gruppe.referenz.lesen', 'gruppe', 'referenz', 'lesen'::berechtigung_aktion, 'gruppe.referenz.lesen', false, 102),
  ('gruppe.reinigung.lesen', 'gruppe', 'reinigung', 'lesen'::berechtigung_aktion, 'gruppe.reinigung.lesen', false, 103),
  ('gruppe.schluessel.lesen', 'gruppe', 'schluessel', 'lesen'::berechtigung_aktion, 'gruppe.schluessel.lesen', false, 104),
  ('gruppe.security.lesen', 'gruppe', 'security', 'lesen'::berechtigung_aktion, 'gruppe.security.lesen', false, 105),
  ('gruppe.social.lesen', 'gruppe', 'social', 'lesen'::berechtigung_aktion, 'gruppe.social.lesen', false, 106),
  ('gruppe.stammdaten.lesen', 'gruppe', 'stammdaten', 'lesen'::berechtigung_aktion, 'gruppe.stammdaten.lesen', false, 107),
  ('gruppe.system.audit_lesen', 'gruppe', 'system_audit', 'lesen'::berechtigung_aktion, 'gruppe.system.audit_lesen', false, 108),
  ('gruppe.system.lesen', 'gruppe', 'system', 'lesen'::berechtigung_aktion, 'gruppe.system.lesen', false, 109),
  ('gruppe.vergabe.lesen', 'gruppe', 'vergabe', 'lesen'::berechtigung_aktion, 'gruppe.vergabe.lesen', false, 110),
  ('gruppe.versand.lesen', 'gruppe', 'versand', 'lesen'::berechtigung_aktion, 'gruppe.versand.lesen', false, 111),
  ('gruppe.wachbuch.lesen', 'gruppe', 'wachbuch', 'lesen'::berechtigung_aktion, 'gruppe.wachbuch.lesen', false, 112),
  ('gruppe.wissen.lesen', 'gruppe', 'wissen', 'lesen'::berechtigung_aktion, 'gruppe.wissen.lesen', false, 113),
  ('gruppe.zahlung.lesen', 'gruppe', 'zahlung', 'lesen'::berechtigung_aktion, 'gruppe.zahlung.lesen', false, 114),
  ('gruppe.zeit.lesen', 'gruppe', 'zeit', 'lesen'::berechtigung_aktion, 'gruppe.zeit.lesen', false, 115),
  ('kalender.lesen', 'kalender', 'kalender', 'lesen'::berechtigung_aktion, 'kalender.lesen', false, 116),
  ('kalender.schreiben', 'kalender', 'kalender', 'schreiben'::berechtigung_aktion, 'kalender.schreiben', false, 117),
  ('kalkulation.lesen', 'kalkulation', 'kalkulation', 'lesen'::berechtigung_aktion, 'kalkulation.lesen', false, 118),
  ('kalkulation.schreiben', 'kalkulation', 'kalkulation', 'schreiben'::berechtigung_aktion, 'kalkulation.schreiben', false, 119),
  ('katalog.lesen', 'katalog', 'katalog', 'lesen'::berechtigung_aktion, 'katalog.lesen', false, 120),
  ('katalog.schreiben', 'katalog', 'katalog', 'schreiben'::berechtigung_aktion, 'katalog.schreiben', false, 121),
  ('mahnung.freigeben', 'mahnung', 'mahnung', 'freigeben'::berechtigung_aktion, 'mahnung.freigeben', false, 122),
  ('mahnung.lesen', 'mahnung', 'mahnung', 'lesen'::berechtigung_aktion, 'mahnung.lesen', false, 123),
  ('mahnung.schreiben', 'mahnung', 'mahnung', 'schreiben'::berechtigung_aktion, 'mahnung.schreiben', false, 124),
  ('nachricht.lesen', 'nachricht', 'nachricht', 'lesen'::berechtigung_aktion, 'nachricht.lesen', false, 125),
  ('nachricht.versenden', 'nachricht', 'nachricht', 'versenden'::berechtigung_aktion, 'nachricht.versenden', false, 126),
  ('nachweis.lesen', 'nachweis', 'nachweis', 'lesen'::berechtigung_aktion, 'nachweis.lesen', false, 127),
  ('nachweis.preis_lesen', 'nachweis', 'preis', 'lesen'::berechtigung_aktion, 'nachweis.preis_lesen', false, 128),
  ('nachweis.schreiben', 'nachweis', 'nachweis', 'schreiben'::berechtigung_aktion, 'nachweis.schreiben', false, 129),
  ('nummernkreis.lesen', 'nummernkreis', 'nummernkreis', 'lesen'::berechtigung_aktion, 'nummernkreis.lesen', false, 130),
  ('nummernkreis.verwalten', 'nummernkreis', 'nummernkreis', 'verwalten'::berechtigung_aktion, 'nummernkreis.verwalten', false, 131),
  ('nummernkreis.ziehen', 'nummernkreis', 'nummernkreis', 'ziehen'::berechtigung_aktion, 'nummernkreis.ziehen', false, 132),
  ('objekt_import.lesen', 'objekt_import', 'objekt_import', 'lesen'::berechtigung_aktion, 'objekt_import.lesen', false, 133),
  ('objekt_import.schreiben', 'objekt_import', 'objekt_import', 'schreiben'::berechtigung_aktion, 'objekt_import.schreiben', false, 134),
  ('objekt.lesen', 'objekt', 'objekt', 'lesen'::berechtigung_aktion, 'objekt.lesen', false, 135),
  ('objekt.schreiben', 'objekt', 'objekt', 'schreiben'::berechtigung_aktion, 'objekt.schreiben', false, 136),
  ('oeffentlich.lesen', 'oeffentlich', 'oeffentlich', 'lesen'::berechtigung_aktion, 'oeffentlich.lesen', false, 137),
  ('personal.aendern', 'personal', 'personal', 'aendern'::berechtigung_aktion, 'personal.aendern', false, 138),
  ('personal.anstellung_beenden', 'personal', 'anstellung', 'beenden'::berechtigung_aktion, 'personal.anstellung_beenden', false, 139),
  ('personal.bewacher_verwalten', 'personal', 'bewacher', 'verwalten'::berechtigung_aktion, 'personal.bewacher_verwalten', false, 140),
  ('personal.entgelt_lesen', 'personal', 'entgelt', 'lesen'::berechtigung_aktion, 'personal.entgelt_lesen', false, 141),
  ('personal.entgelt_schreiben', 'personal', 'entgelt', 'schreiben'::berechtigung_aktion, 'personal.entgelt_schreiben', false, 142),
  ('personal.erstattung_lesen', 'personal', 'erstattung', 'lesen'::berechtigung_aktion, 'personal.erstattung_lesen', false, 143),
  ('personal.erstellen', 'personal', 'personal', 'erstellen'::berechtigung_aktion, 'personal.erstellen', false, 144),
  ('personal.lesen', 'personal', 'personal', 'lesen'::berechtigung_aktion, 'personal.lesen', false, 145),
  ('personal.nachweis_lesen', 'personal', 'nachweis', 'lesen'::berechtigung_aktion, 'personal.nachweis_lesen', false, 146),
  ('personal.nachweis_verwalten', 'personal', 'nachweis', 'verwalten'::berechtigung_aktion, 'personal.nachweis_verwalten', false, 147),
  ('personal.schreiben', 'personal', 'personal', 'schreiben'::berechtigung_aktion, 'personal.schreiben', false, 148),
  ('personal.stammdaten_lesen', 'personal', 'stammdaten', 'lesen'::berechtigung_aktion, 'personal.stammdaten_lesen', false, 149),
  ('personal.zugang_verwalten', 'personal', 'zugang', 'verwalten'::berechtigung_aktion, 'personal.zugang_verwalten', false, 150),
  ('personal.zusammenfuehren', 'personal', 'personal', 'zusammenfuehren'::berechtigung_aktion, 'personal.zusammenfuehren', false, 151),
  ('qualitaet.lesen', 'qualitaet', 'qualitaet', 'lesen'::berechtigung_aktion, 'qualitaet.lesen', false, 152),
  ('qualitaet.schreiben', 'qualitaet', 'qualitaet', 'schreiben'::berechtigung_aktion, 'qualitaet.schreiben', false, 153),
  ('radar.lesen', 'radar', 'radar', 'lesen'::berechtigung_aktion, 'radar.lesen', false, 154),
  ('radar.plattform_verwalten', 'radar', 'plattform', 'verwalten'::berechtigung_aktion, 'radar.plattform_verwalten', false, 155),
  ('radar.profil_schreiben', 'radar', 'profil', 'schreiben'::berechtigung_aktion, 'radar.profil_schreiben', false, 156),
  ('radar.status_setzen', 'radar', 'status', 'setzen'::berechtigung_aktion, 'radar.status_setzen', false, 157),
  ('recruiting.bewerbung_bewerten', 'recruiting', 'bewerbung', 'bewerten'::berechtigung_aktion, 'recruiting.bewerbung_bewerten', false, 158),
  ('recruiting.bewerbung_lesen', 'recruiting', 'bewerbung', 'lesen'::berechtigung_aktion, 'recruiting.bewerbung_lesen', false, 159),
  ('recruiting.daten_loeschen', 'recruiting', 'daten', 'loeschen'::berechtigung_aktion, 'recruiting.daten_loeschen', false, 160),
  ('recruiting.entscheiden', 'recruiting', 'recruiting', 'entscheiden'::berechtigung_aktion, 'recruiting.entscheiden', false, 161),
  ('recruiting.stelle_lesen', 'recruiting', 'stelle', 'lesen'::berechtigung_aktion, 'recruiting.stelle_lesen', false, 162),
  ('recruiting.stelle_schreiben', 'recruiting', 'stelle', 'schreiben'::berechtigung_aktion, 'recruiting.stelle_schreiben', false, 163),
  ('recruiting.stelle_veroeffentlichen', 'recruiting', 'stelle', 'veroeffentlichen'::berechtigung_aktion, 'recruiting.stelle_veroeffentlichen', false, 164),
  ('referenz.kundenfreigabe_erfassen', 'referenz', 'kundenfreigabe', 'erfassen'::berechtigung_aktion, 'referenz.kundenfreigabe_erfassen', false, 165),
  ('referenz.lesen', 'referenz', 'referenz', 'lesen'::berechtigung_aktion, 'referenz.lesen', false, 166),
  ('referenz.schreiben', 'referenz', 'referenz', 'schreiben'::berechtigung_aktion, 'referenz.schreiben', false, 167),
  ('referenz.veroeffentlichen', 'referenz', 'referenz', 'veroeffentlichen'::berechtigung_aktion, 'referenz.veroeffentlichen', false, 168),
  ('reinigung.lesen', 'reinigung', 'reinigung', 'lesen'::berechtigung_aktion, 'reinigung.lesen', false, 169),
  ('reinigung.schreiben', 'reinigung', 'reinigung', 'schreiben'::berechtigung_aktion, 'reinigung.schreiben', false, 170),
  ('schluessel.lesen', 'schluessel', 'schluessel', 'lesen'::berechtigung_aktion, 'schluessel.lesen', false, 171),
  ('schluessel.schreiben', 'schluessel', 'schluessel', 'schreiben'::berechtigung_aktion, 'schluessel.schreiben', false, 172),
  ('security.lesen', 'security', 'security', 'lesen'::berechtigung_aktion, 'security.lesen', false, 173),
  ('security.schreiben', 'security', 'security', 'schreiben'::berechtigung_aktion, 'security.schreiben', false, 174),
  ('social.freigeben', 'social', 'social', 'freigeben'::berechtigung_aktion, 'social.freigeben', false, 175),
  ('social.kanal_verbinden', 'social', 'kanal', 'verbinden'::berechtigung_aktion, 'social.kanal_verbinden', false, 176),
  ('social.lesen', 'social', 'social', 'lesen'::berechtigung_aktion, 'social.lesen', false, 177),
  ('social.planen', 'social', 'social', 'planen'::berechtigung_aktion, 'social.planen', false, 178),
  ('social.schreiben', 'social', 'social', 'schreiben'::berechtigung_aktion, 'social.schreiben', false, 179),
  ('stammdaten.verwalten', 'stammdaten', 'stammdaten', 'verwalten'::berechtigung_aktion, 'stammdaten.verwalten', false, 180),
  ('system.audit_exportieren', 'system', 'audit', 'exportieren'::berechtigung_aktion, 'system.audit_exportieren', false, 181),
  ('system.audit_lesen', 'system', 'audit', 'lesen'::berechtigung_aktion, 'system.audit_lesen', false, 182),
  ('system.audit_sensitiv_lesen', 'system', 'audit_sensitiv', 'lesen'::berechtigung_aktion, 'system.audit_sensitiv_lesen', false, 183),
  ('system.benutzer_lesen', 'system', 'benutzer', 'lesen'::berechtigung_aktion, 'system.benutzer_lesen', false, 184),
  ('system.benutzer_verwalten', 'system', 'benutzer', 'verwalten'::berechtigung_aktion, 'system.benutzer_verwalten', false, 185),
  ('system.betrieb_lesen', 'system', 'betrieb', 'lesen'::berechtigung_aktion, 'system.betrieb_lesen', false, 186),
  ('system.einstellung_lesen', 'system', 'einstellung', 'lesen'::berechtigung_aktion, 'system.einstellung_lesen', false, 187),
  ('system.einstellung_verwalten', 'system', 'einstellung', 'verwalten'::berechtigung_aktion, 'system.einstellung_verwalten', false, 188),
  ('system.feed_token_widerrufen', 'system', 'feed_token', 'widerrufen'::berechtigung_aktion, 'system.feed_token_widerrufen', false, 189),
  ('system.identitaet_verwalten', 'system', 'identitaet', 'verwalten'::berechtigung_aktion, 'system.identitaet_verwalten', false, 190),
  ('system.mandant_lesen', 'system', 'mandant', 'lesen'::berechtigung_aktion, 'system.mandant_lesen', false, 191),
  ('system.mandant_verwalten', 'system', 'mandant', 'verwalten'::berechtigung_aktion, 'system.mandant_verwalten', true, 192),
  ('system.module_zuweisen', 'system', 'module', 'zuweisen'::berechtigung_aktion, 'system.module_zuweisen', false, 193),
  ('system.protokoll_lesen', 'system', 'protokoll', 'lesen'::berechtigung_aktion, 'system.protokoll_lesen', false, 194),
  ('system.referenzdaten_verwalten', 'system', 'referenzdaten', 'verwalten'::berechtigung_aktion, 'system.referenzdaten_verwalten', false, 195),
  ('system.rolle_lesen', 'system', 'rolle', 'lesen'::berechtigung_aktion, 'system.rolle_lesen', false, 196),
  ('system.rolle_verwalten', 'system', 'rolle', 'verwalten'::berechtigung_aktion, 'system.rolle_verwalten', false, 197),
  ('system.sitzung_lesen', 'system', 'sitzung', 'lesen'::berechtigung_aktion, 'system.sitzung_lesen', false, 198),
  ('system.sitzung_widerrufen', 'system', 'sitzung', 'widerrufen'::berechtigung_aktion, 'system.sitzung_widerrufen', false, 199),
  ('system.zwei_faktor_zuruecksetzen', 'system', 'zwei_faktor', 'zuruecksetzen'::berechtigung_aktion, 'system.zwei_faktor_zuruecksetzen', true, 200),
  ('vergabe.einreichung_erfassen', 'vergabe', 'einreichung', 'erfassen'::berechtigung_aktion, 'vergabe.einreichung_erfassen', false, 201),
  ('vergabe.lesen', 'vergabe', 'vergabe', 'lesen'::berechtigung_aktion, 'vergabe.lesen', false, 202),
  ('vergabe.schreiben', 'vergabe', 'vergabe', 'schreiben'::berechtigung_aktion, 'vergabe.schreiben', false, 203),
  ('versand.freigeben', 'versand', 'versand', 'freigeben'::berechtigung_aktion, 'versand.freigeben', false, 204),
  ('versand.lesen', 'versand', 'versand', 'lesen'::berechtigung_aktion, 'versand.lesen', false, 205),
  ('wachbuch.lesen', 'wachbuch', 'wachbuch', 'lesen'::berechtigung_aktion, 'wachbuch.lesen', false, 206),
  ('wachbuch.schreiben', 'wachbuch', 'wachbuch', 'schreiben'::berechtigung_aktion, 'wachbuch.schreiben', false, 207),
  ('zahlung.lesen', 'zahlung', 'zahlung', 'lesen'::berechtigung_aktion, 'zahlung.lesen', false, 208),
  ('zahlung.schreiben', 'zahlung', 'zahlung', 'schreiben'::berechtigung_aktion, 'zahlung.schreiben', false, 209),
  ('zeit.abrechnung_freigeben', 'zeit', 'abrechnung', 'freigeben'::berechtigung_aktion, 'zeit.abrechnung_freigeben', false, 210),
  ('zeit.abwesenheit_genehmigen', 'zeit', 'abwesenheit', 'genehmigen'::berechtigung_aktion, 'zeit.abwesenheit_genehmigen', false, 211),
  ('zeit.abwesenheit_grund_lesen', 'zeit', 'abwesenheit_grund', 'lesen'::berechtigung_aktion, 'zeit.abwesenheit_grund_lesen', false, 212),
  ('zeit.abwesenheit_lesen', 'zeit', 'abwesenheit', 'lesen'::berechtigung_aktion, 'zeit.abwesenheit_lesen', false, 213),
  ('zeit.abwesenheit_melden', 'zeit', 'abwesenheit', 'melden'::berechtigung_aktion, 'zeit.abwesenheit_melden', false, 214),
  ('zeit.antrag_entscheiden', 'zeit', 'antrag', 'entscheiden'::berechtigung_aktion, 'zeit.antrag_entscheiden', false, 215),
  ('zeit.checkin_verwalten', 'zeit', 'checkin', 'verwalten'::berechtigung_aktion, 'zeit.checkin_verwalten', false, 216),
  ('zeit.einwand_entscheiden', 'zeit', 'einwand', 'entscheiden'::berechtigung_aktion, 'zeit.einwand_entscheiden', false, 217),
  ('zeit.exportieren', 'zeit', 'zeit', 'exportieren'::berechtigung_aktion, 'zeit.exportieren', false, 218),
  ('zeit.konto_abschliessen', 'zeit', 'konto', 'abschliessen'::berechtigung_aktion, 'zeit.konto_abschliessen', false, 219),
  ('zeit.konto_korrigieren', 'zeit', 'konto', 'korrigieren'::berechtigung_aktion, 'zeit.konto_korrigieren', false, 220),
  ('zeit.konto_lesen', 'zeit', 'konto', 'lesen'::berechtigung_aktion, 'zeit.konto_lesen', false, 221),
  ('zeit.korrigieren', 'zeit', 'zeit', 'korrigieren'::berechtigung_aktion, 'zeit.korrigieren', false, 222),
  ('zeit.lesen', 'zeit', 'zeit', 'lesen'::berechtigung_aktion, 'zeit.lesen', false, 223),
  ('zeit.nacherfassung_pruefen', 'zeit', 'nacherfassung', 'pruefen'::berechtigung_aktion, 'zeit.nacherfassung_pruefen', false, 224),
  ('zeit.schreiben', 'zeit', 'zeit', 'schreiben'::berechtigung_aktion, 'zeit.schreiben', false, 225);
