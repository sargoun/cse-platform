...
insert into berechtigung (schluessel, modul, objekt, aktion, bezeichnung, nur_global, sortierung) values
  ...
  ('system.zwei_faktor_zuruecksetzen', 'system', 'zwei_faktor', 'zuruecksetzen'::berechtigung_aktion, 'system.zwei_faktor_zuruecksetzen', true, 214),
  ('vergabe.einreichung_erfassen', 'vergabe', 'einreichung', 'erfassen'::berechtigung_aktion, 'vergabe.einreichung_erfassen', false, 215),
  ('vergabe.lesen', 'vergabe', 'vergabe', 'lesen'::berechtigung_aktion, 'vergabe.lesen', false, 216),
  ('vergabe.schreiben', 'vergabe', 'vergabe', 'schreiben'::berechtigung_aktion, 'vergabe.schreiben', false, 217),
  ('versand.freigeben', 'versand', 'versand', 'freigeben'::berechtigung_aktion, 'versand.freigeben', false, 218),
  ('versand.lesen', 'versand', 'versand', 'lesen'::berechtigung_aktion, 'versand.lesen', false, 219),
  ('wachbuch.lesen', 'wachbuch', 'wachbuch', 'lesen'::berechtigung_aktion, 'wachbuch.lesen', false, 220),
  ('wachbuch.schreiben', 'wachbuch', 'wachbuch', 'schreiben'::berechtigung_aktion, 'wachbuch.schreiben', false, 221),
  ('wissen.lesen', 'wissen', 'wissen', 'lesen'::berechtigung_aktion, 'wissen.lesen', false, 222),
  ('wissen.vertraulich_lesen', 'wissen', 'vertraulich', 'lesen'::berechtigung_aktion, 'wissen.vertraulich_lesen', false, 223),
  ('zahlung.lesen', 'zahlung', 'zahlung', 'lesen'::berechtigung_aktion, 'zahlung.lesen', false, 224),
  ('zahlung.schreiben', 'zahlung', 'zahlung', 'schreiben'::berechtigung_aktion, 'zahlung.schreiben', false, 225),
  ('zeit.abrechnung_freigeben', 'zeit', 'abrechnung', 'freigeben'::berechtigung_aktion, 'zeit.abrechnung_freigeben', false, 226),
  ('zeit.abwesenheit_genehmigen', 'zeit', 'abwesenheit', 'genehmigen'::berechtigung_aktion, 'zeit.abwesenheit_genehmigen', false, 227),
  ('zeit.abwesenheit_grund_lesen', 'zeit', 'abwesenheit_grund', 'lesen'::berechtigung_aktion, 'zeit.abwesenheit_grund_lesen', false, 228),
  ('zeit.abwesenheit_lesen', 'zeit', 'abwesenheit', 'lesen'::berechtigung_aktion, 'zeit.abwesenheit_lesen', false, 229),
  ('zeit.abwesenheit_melden', 'zeit', 'abwesenheit', 'melden'::berechtigung_aktion, 'zeit.abwesenheit_melden', false, 230),
  ('zeit.antrag_entscheiden', 'zeit', 'antrag', 'entscheiden'::berechtigung_aktion, 'zeit.antrag_entscheiden', false, 231),
  ('zeit.checkin_verwalten', 'zeit', 'checkin', 'verwalten'::berechtigung_aktion, 'zeit.checkin_verwalten', false, 232),
  ('zeit.einwand_entscheiden', 'zeit', 'einwand', 'entscheiden'::berechtigung_aktion, 'zeit.einwand_entscheiden', false, 233),
  ('zeit.exportieren', 'zeit', 'zeit', 'exportieren'::berechtigung_aktion, 'zeit.exportieren', false, 234),
  ('zeit.konto_abschliessen', 'zeit', 'konto', 'abschliessen'::berechtigung_aktion, 'zeit.konto_abschliessen', false, 235),
  ('zeit.konto_korrigieren', 'zeit', 'konto', 'korrigieren'::berechtigung_aktion, 'zeit.konto_korrigieren', false, 236),
  ('zeit.konto_lesen', 'zeit', 'konto', 'lesen'::berechtigung_aktion, 'zeit.konto_lesen', false, 237),
  ('zeit.korrigieren', 'zeit', 'zeit', 'korrigieren'::berechtigung_aktion, 'zeit.korrigieren', false, 238),
  ('zeit.lesen', 'zeit', 'zeit', 'lesen'::berechtigung_aktion, 'zeit.lesen', false, 239),
  ('zeit.nacherfassung_pruefen', 'zeit', 'nacherfassung', 'pruefen'::berechtigung_aktion, 'zeit.nacherfassung_pruefen', false, 240),
  ('zeit.schreiben', 'zeit', 'zeit', 'schreiben'::berechtigung_aktion, 'zeit.schreiben', false, 241);
