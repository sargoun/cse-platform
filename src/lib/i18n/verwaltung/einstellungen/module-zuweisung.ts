 ...
 * und im Protokoll; auf dem Bildschirm steht, was sie bedeuten. Der Schlüssel
 * bleibt im `title` für die Verwaltung, die ihn wörtlich braucht.
 *
...
export const MODUL_ZUWEISUNG_TEXTE: Readonly<Record<InternSprache, ModulZuweisungTexte>> = {
  de: {
    ...
    meldung: {
      ...
      nicht_erlaubt: 'Diese Änderung ist nicht möglich.',
    },
  },
  en: {
    ...
    meldung: {
      ...
      nicht_erlaubt: 'This change is not possible.',
    },
  },
};
