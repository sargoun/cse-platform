...
/**
 * `/unternehmen/[bereich]/beitraege` — SEITENKARTE §2.2
 *
...
export async function generateMetadata(
  ...
  return { title: `${titelFuer('beitraege', 'de')} — ${daten.name}` };
}
...
export default async function Seite(
  ...
  const { bereich } = await params;
  return <BeitraegeSeite bereich={bereich} sprache="de" segment="beitraege" />;
}
