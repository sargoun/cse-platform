...
/**
 * `/en/unternehmen/[bereich]/unternehmensdaten` — SEITENKARTE §2.2
 *
...
export async function generateMetadata(
  ...
  return { title: `${titelFuer('unternehmensdaten', 'en')} — ${daten.name}` };
}
...
export default async function Seite(
  ...
  const { bereich } = await params;
  return <UnternehmensdatenSeite bereich={bereich} sprache="en" />;
}
