...
/**
 * `/en/unternehmen/[bereich]/news/[slug]` — die KANONISCHE Adresse eines Beitrags (SEITENKARTE §2.2).
 *
...
export async function generateMetadata(
   ...
   */
  return beitragsMetadaten(bereich, slug, 'en');
}
...
export default async function Seite(
  ...
  const { bereich, slug } = await params;
  return (
    <BeitragDetailSeite bereich={bereich} slug={slug} sprache="en" segment="news" />
  );
}
