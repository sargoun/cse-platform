...
import { ProjektDetailSeite } from '@/app/(public)/unternehmen/[bereich]/_profil/seiten';
import { ladeBereich } from '@/app/(public)/unternehmen/[bereich]/_profil/Rahmen';

/**
 * `/en/unternehmen/[bereich]/projekte/[slug]` — die KANONISCHE Adresse eines Projekts (SEITENKARTE §2.2).
 *
 * Die Gruppenliste unter `/projekte` verweist hierher und setzt
...
export default async function Seite(
  ...
  return (
    <ProjektDetailSeite bereich={bereich} slug={slug} sprache="en" />
  );
}
