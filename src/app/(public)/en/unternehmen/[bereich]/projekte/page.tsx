...
import { ProjekteSeite } from '@/app/(public)/unternehmen/[bereich]/_profil/seiten';
...
/**
 * `/en/unternehmen/[bereich]/projekte` — SEITENKARTE §2.2
 *
...
export async function generateMetadata(
  ...
  return { title: `${titelFuer('projekte', 'en')} — ${daten.name}` };
}
...
export default async function Seite(
  ...
  const { bereich } = await params;
  return <ProjekteSeite bereich={bereich} sprache="en" />;
}
