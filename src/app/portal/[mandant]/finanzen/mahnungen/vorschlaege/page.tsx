...
/**
 * `/portal/[mandant]/finanzen/mahnungen/vorschlaege` — noch nicht gebaut, und das steht hier
 * ausdrücklich als eigene Datei.
 *
 * **Warum eine Datei fuer eine Seite, die es nicht gibt.** Ohne sie greift
 * Next.js die Nachbarroute `[id]`, reicht `vorschlaege` als Kennung in ein
...
export default async function Platzhalter(
  ...
  return <MandantUnterseite segmente={['finanzen', 'mahnungen', 'vorschlaege']} mandant={mandant} />;
}
