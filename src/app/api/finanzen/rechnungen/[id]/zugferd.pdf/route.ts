 ...
 * (FIN-12, PR 53).
 *
 * **Dasselbe Tor, dieselbe Quelle, anderes Format.** Die Schwester dieser
 * Route liefert die XRechnung als XML; hier kommt ein PDF/A-3, in dem
 * dieselbe Rechnung als CII eingebettet liegt. Beide lesen den SELBEN
 * Snapshot (K-12), beide prüfen dasselbe Recht, und beide entstehen gar nicht,
